...
/* bian add  ------------------> */
#define TL_WR703N_GPIO_KEY_STAT		14
#define TL_WR703N_GPIO_KEY_OUT		15
#define TL_WR703N_GPIO_LED_KEY		16
/* <------------------- bian add  */
...
/* bian add  ------------------> */
	{
		.name		= "tp-link:led16:test",
		.gpio		= TL_WR703N_GPIO_LED_KEY,
		.active_low	= 1,
	},
/* <------------------- bian add */
};
...
/* bian add  -----------------> */
	gpio_request_one(TL_WR703N_GPIO_KEY_STAT,
			 GPIOF_IN | GPIOF_EXPORT_DIR_FIXED,
			 "Key stat");

	gpio_request_one(TL_WR703N_GPIO_KEY_OUT,
