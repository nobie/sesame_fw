...
m2 = Map("passcode", translate("Entry Passcode"), translate("Set operating passcode"))

s = m2:section(TypedSection,"user")
s.anonymous = true
s.addremove = false

----s:option(Value, "id", translate("User name"), translate("the user's id"))

key=s:option(Value, "code", translate("Password"), translate("the User's password"))
key.rmempty = true
key.password = true
