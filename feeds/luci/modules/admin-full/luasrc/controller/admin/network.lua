...
--- 08/15 bian rm 			page.title  = _("DHCP and DNS")
--- 08/15 bian rm 			page.order  = 30
...
--- 08/15 bian rm 			page.title  = _("Hostnames")
--- 08/15 bian rm 			page.order  = 40
		end

		if nixio.fs.access("/etc/config/6relayd") then
			page = node("admin", "network", "ipv6")
			page.target = cbi("admin_network/ipv6")
--- 08/15 bian rm 			page.title  = _("IPv6 RA and DHCPv6")
--- 08/15 bian rm 			page.order  = 45
		end

		page  = node("admin", "network", "routes")
		page.target = cbi("admin_network/routes")
--- 08/15 bian rm 		page.title  = _("Static Routes")
--- 08/15 bian rm 		page.order  = 50

		page = node("admin", "network", "diagnostics")
		page.target = template("admin_network/diagnostics")
--- 08/15 bian rm 		page.title  = _("Diagnostics")
--- 08/15 bian rm 		page.order  = 60
